...
const SideNavbar = () => {
  ...
  const { broken, toggleSidebar, toggled, collapsed, collapseSidebar } =
    useProSidebar();
  ...
  return (
    ...
    >
      <Menu rootStyles={MenuStyle} menuItemStyles={MenuItemStyle}>
        <MenuItem
          title="Home"
